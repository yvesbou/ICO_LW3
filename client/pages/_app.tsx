...
import { RainbowKitProvider, getDefaultWallets, lightTheme as rainbowKitLightTheme, darkTheme as rainbowKitDarkTheme } from '@rainbow-me/rainbowkit';
...
function MyApp({ Component, pageProps }: AppProps) {
  return (
    <WagmiConfig client={wagmiClient}>
      <RainbowKitProvider chains={chains} theme={{lightMode: rainbowKitLightTheme(), darkMode: rainbowKitDarkTheme()}}>
        <NextThemesProvider
          defaultTheme="system"
          attribute="class"
          value={{
